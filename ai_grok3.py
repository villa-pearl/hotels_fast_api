...
- если период проживания указан не в виде даты, а в виде названия периода - смотри дополнительные данные 
  где указаны названия периодов и указание дат
- Размещай начало и конец периода в разные колонки
- Все даты выводи в формате dd.mm.YYYY (пример 25.02.2026)
- цену дополнительной кровати, если номер позволяет такое размещение (проверяй тип номера)
...
- отдельно указывай special offers если он есть
- условия для детей
...
Используя даты праздников (Public Holidays а также DIFF Surcharge) учитывай дополнительные оплаты в эти дни и выведи
дополнительную итоговую таблицу с указанием 
- название и тип номера
- цену проживания в номере по периодам с датами
- если период проживания указан не в виде даты, а в виде названия периода - смотри дополнилнительные данные 
  где указаны названия периодов и указание дат, с разбивкой дат праздниками
- все даты выводи в формате dd.mm.YYYY (пример 25.02.2026)
- Размещай начало и конец периода в разные колонки
- цену дополнительной кровати
- учитывай цены за размещение в празничные дни и указывай итоговую суммы в празничные дни.
- доплаты за питание включать не нужно
